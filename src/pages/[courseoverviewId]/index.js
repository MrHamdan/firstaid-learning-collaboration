   ...
   <Box sx={Styles.detailBackground}>
    ...
    >
     <Box>
      ...
      <Box sx={{ display: "flex", lineHeight: "32px" }}>
       ...
       <Typography sx={{ marginRight: "20px" }}>( 50 REVIEWS )</Typography>
       <Typography sx={{ marginRight: "20px" }}>6245 STUDENTS</Typography>
      </Box>
      <Typography
       sx={{
        fontStyle: "normal",
      ...
      >
       ...
       courses for anyone <br /> who wishes to take their professional life to
       the next level.
      </Typography>
     </Box>
     <Box>
