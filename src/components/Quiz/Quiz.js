import { Box, Button, Card, Container, FormControl, FormControlLabel, Radio, RadioGroup, Typography } from "@mui/material";
...
const Quiz = () => {
    ...
    }, [index, isSubmitted, isSelected,dispatch,selectedAnswer,userSelectedAnswers])
    const goNext = () => {
    ...
    }}>
        {
            ...
            <Card sx={{
               width:{
                ...
                <Typography variant='h6' sx={{textAlign: 'left'}}><Box sx={{display: 'inline', background:'red',px:"6px",py:'2px',borderRadius: '4px',color:"#fff"}}>{quiz[index]?.id}</Box>. {quiz[index]?.question}</Typography>
